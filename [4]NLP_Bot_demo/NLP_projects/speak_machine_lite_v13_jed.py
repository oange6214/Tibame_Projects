...
def windowTkinter():
    ...
    def Get_Audio():
        global set_windows_close_timer

        if set_windows_close_timer != 0:
            set_windows_close_timer.cancel()
        # 進行錄音
        ...
        try:
            ...
            set_windows_close_timer = Timer(10, Close_Window)
            set_windows_close_timer.start()
    ...
    def get_image():
        image_list=sorted(glob.glob('./QRcode/*.jpg',recursive=True)) #for recurisve
        # base_path = ('./QRcode') 
